    ...
    <div class="form-card">
        <div class="form-header">
            <div style="display: flex; align-items: center; gap: 12px;">
                ...
                <div>
                    <h2 style="margin: 0; font-size: 24px; color: #333;">Sửa Đợt đăng ký</h2>
                    <p style="margin: 4px 0 0 0; color: #888; font-size: 14px;">Cập nhật cấu hình đợt đăng ký hiện có</p>
                </div>
            </div>
        </div>
        ...
        <form action="{{ route('registration-waves.update', $wave) }}" method="POST">
            ...
            <div class="form-row cols-2">
                <div class="form-group">
                    ...
                    <input type="text" name="academic_year" class="form-input @error('academic_year') is-invalid @enderror" value="{{ old('academic_year', $wave->academic_year) }}" required>
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-input @error('name') is-invalid @enderror" value="{{ old('name', $wave->name) }}" required>
            ...
            <div class="form-row cols-2">
                <div class="form-group">
                    ...
                    <input type="datetime-local" name="starts_at" class="form-input @error('starts_at') is-invalid @enderror" value="{{ old('starts_at', \Carbon\Carbon::parse($wave->starts_at)->format('Y-m-d\TH:i')) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" name="ends_at" class="form-input @error('ends_at') is-invalid @enderror" value="{{ old('ends_at', \Carbon\Carbon::parse($wave->ends_at)->format('Y-m-d\TH:i')) }}" required>
            ...
            <div class="form-group">
                ...
                <div style="border: 1px solid #e0e0e0; border-radius: 8px; padding: 16px; background: #fafafa;">
                    ...
                    <div class="form-check" style="margin-bottom: 10px;">
                        <input class="form-check-input" type="checkbox" name="faculties[]" value="{{ $faculty->id }}" id="faculty{{ $faculty->id }}" {{ in_array($faculty->id, $selectedFaculties) ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <div style="border: 1px solid #e0e0e0; border-radius: 8px; padding: 16px; background: #fafafa;">
                    ...
                    <div class="form-check form-check-inline" style="margin-bottom: 10px;">
                        <input class="form-check-input" type="checkbox" name="cohorts[]" value="{{ $cohort }}" id="cohort{{ $cohort }}" {{ in_array($cohort, $selectedCohorts) ? 'checked' : '' }}>
            ...
            <div style="display: flex; gap: 12px; margin-top: 24px;">
                <button type="submit" class="btn-submit"><i class="fas fa-save" style="margin-right: 8px;"></i>Cập nhật</button>
