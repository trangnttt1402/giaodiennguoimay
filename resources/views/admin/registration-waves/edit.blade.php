...
<div class="wave-container">
    <div class="wave-card">
        <div class="wave-header">
            ...
            <h1><i class="fas fa-edit"></i> Sửa Đợt đăng ký</h1>
            <p>Cập nhật cấu hình và thông tin đợt đăng ký</p>
        </div>
            ...
            <div class="wave-body">
                ...
                <div class="grid-2">
                    <div class="input-group">
                        ...
                        <input type="text" name="academic_year" class="input-field @error('academic_year') is-invalid @enderror" value="{{ old('academic_year', $wave->academic_year) }}" required>
                        @error('academic_year')
                    ...
                    <div class="input-group">
                        ...
                        <select name="term" class="input-field @error('term') is-invalid @enderror" required>
                            ...
                            <option value="HK3" {{ old('term', $wave->term) == 'HK3' ? 'selected' : '' }}>☀️ Học kỳ 3 (Hè)</option>
                        </select>
                        @error('term')
                        <div class="error-message">
                            <i class="fas fa-exclamation-circle"></i>{{ $message }}
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="name" class="input-field @error('name') is-invalid @enderror" value="{{ old('name', $wave->name) }}" required>
                    @error('name')
                    <div class="error-message">
                        <i class="fas fa-exclamation-circle"></i>{{ $message }}
                    </div>
                ...
                <div class="grid-2">
                    <div class="input-group">
                        ...
                        <input type="datetime-local" name="starts_at" class="input-field @error('starts_at') is-invalid @enderror" value="{{ old('starts_at', \Carbon\Carbon::parse($wave->starts_at)->format('Y-m-d\TH:i')) }}" required>
                        @error('starts_at')
                        <div class="error-message">
                            <i class="fas fa-exclamation-circle"></i>{{ $message }}
                        </div>
                    ...
                    <div class="input-group">
                        ...
                        <input type="datetime-local" name="ends_at" class="input-field @error('ends_at') is-invalid @enderror" value="{{ old('ends_at', \Carbon\Carbon::parse($wave->ends_at)->format('Y-m-d\TH:i')) }}" required>
                        @error('ends_at')
                        <div class="error-message">
                            <i class="fas fa-exclamation-circle"></i>{{ $message }}
                        </div>
                ...
                <div class="input-group">
                    ...
                    <div class="checkbox-group">
                        ...
                        <div class="checkbox-item">
                            <input type="checkbox" name="faculties[]" value="{{ $faculty->id }}" id="faculty{{ $faculty->id }}" {{ in_array($faculty->id, $selectedFaculties) ? 'checked' : '' }}>
                    ...
                    <div class="checkbox-group">
                        <div class="cohort-grid">
                            ...
                            <label class="cohort-item">
                                <input type="checkbox" name="cohorts[]" value="{{ $cohort }}" id="cohort{{ $cohort }}" {{ in_array($cohort, $selectedCohorts) ? 'checked' : '' }}>
